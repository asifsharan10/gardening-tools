        ...
        <div class="product-wrapper row" id="single_pdt_id">
            ...
            <div class="pdt-image col-lg-7 col-12">
                ...
                <div class="price-col">
                    <p>
                        Total: $<span
                            id="single_pdt_price"><?= (isset($subtotalPrice) && isset($shippingPrice)) ? sprintf("%0.2f", $subtotalPrice + $shippingPrice) : 0; ?></span>
                    </p>
                ...
                <div class="qty-col1" id="pdt_type_5" style="display: none;">
                    <select class="form-control selectbox" style="margin-bottom: 10px; width: 35%;">

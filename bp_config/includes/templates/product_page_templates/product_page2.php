            ...
            <div class="pdt-image col-lg-3 col-12">
                <a href="" data-bs-toggle="modal" data-bs-target="#img-lightbox" id="lightbox-wrapper">
                    <div class="pdt-img-wrapper">
                        ...
                        <i class="fal fa-search-plus" data-toggle="tooltip" data-placement="top"
                            title="View Large Image"></i>
                    </div>
                </a>
            </div>
            <div class="pdt-data col-lg-9 col-12">
                ...
                <div class="title-col">
                    ...
                    <div class="category-col"
                        style="display: <?= $pageConfig['displayCategory'] == 'yes' ? 'block' : 'none'; ?>;">
                        <p>
                ...
                <div class="price-col">
                    <p>
                        Total: <span class="pdt-price-wrapper">$<span
                                id="single_pdt_price"><?= (isset($subtotalPrice) && isset($shippingPrice)) ? sprintf("%0.2f", $subtotalPrice + $shippingPrice) : 0; ?></span></span>
                    </p>
                ...
                <div class="qty-col1" id="pdt_type_5" style="display: none;">
                    <select class="form-control selectbox"
                        style="border: 1px solid #ccc; padding: 10px; text-align: center; width: 30%; margin-bottom: 10px; border-radius: 10px;">
                        <option>Choose a Purchase Option</option>
                        <option id="s_sale" value="1"><?= $generalConfig['naming_convention']['1'] ?></option>
                ...
                <div class="pdt-add btn-qty-wrapper">
                    ...
                    <div class="qty-col" style="display: none;">
                        ...
                        <button type="button" class="material-icons span_counter" id="decrease" disabled=""> remove
                        </button>
                    ...
                    <div class="pdt-button">
                        <button type="button" class="btn btn-primary btn-cart pdt-page-btn-color"
                            onclick="AddtoCart()"><i class="far fa-shopping-bag me-2"></i>Add to cart</button>
                    </div>
                </div>
